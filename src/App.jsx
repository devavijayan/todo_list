...
function App() {
  ...
  return (
    ...
    <div className="App w-full h-screen flex justify-center items-center">
      <div 
      className='w-4/5 md:w-1/2 lg:w-4/12 2xl:w-1/5 m-auto h-1/2 overflow-auto
       bg-blue-400 rounded-md drop-shadow-xl border relative'>
        <div className='w-full sticky top-0 bg-[#161616]
         text-gray-200 p-4 flex justify-between items-center'>
          <div>
